...
describe('Questionnaire Types', ()=>{
    ...
    it('Edits a Questionnaire Type', () => {
        ...
        cy.get('#gridQuestionnaireTypes tr .dx-first-cell .dx-texteditor-input').type('Type DKA Test', {force:true}).wait(2000)
        ...
        cy.get('@grades').eq(5).clear().wait(1000).type('Type DKA Test Updated', {force: true}).wait(1000)
