...
/**
 * @testSuite ClientCapacity - Authorized Person Management
 * @description Test suite for adding, editing, and deleting authorized persons for corporate clients
 * @priority Medium
 * @owner QA Team
 * @tags corporate, capacity, regression
 * @dependencies faker-js, client-corporate
 * @fileDescription Tests the workflow for managing authorized persons under client capacity
 */
...
describe('Capacity - Corporate', () => {
    ...
    /**
     * @scenario Add Authorized Person
     * @description Adds an authorized person to a corporate client using a new profile
     * @testData Dynamically generated first name, middle name, and contact info
     * @steps Read client name from fixture and navigate to dashboard
     * @steps Fill in authorized person form fields
     * @steps Select controlling person type and check capacities
     * @expectedResult Authorized person is successfully created and visible in the grid
     */
    it('Adds Authorized Person', () => {
        ...
        cy.get('dx-drop-down-box').eq(2).click().wait(2000)
    ...
    /**
     * @scenario Edit Authorized Person
     * @description Updates weight and verifies tree view contains full name
     * @steps Visit same client, open authorized person record
     * @steps Clear weight field and update with new value
     * @expectedResult Person’s weight and name updates are applied successfully
     */
    ...
    /**
     * @scenario Delete Authorized Person
     * @description Removes the authorized person from client capacity
     * @steps Navigate to capacity section and click trash icon
     * @expectedResult Deletion confirmation and success message displayed
     */
