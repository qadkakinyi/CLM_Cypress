describe('Scenario 1: Transaction Screening - Individual Client with corporateEntities only', () => {
    const corporateEntity = 'Complytek';

    it('Performs transaction screening for individual client with corporateEntities only and asserts Auto Status', () => {
        let clientName;
...
describe('Scenario 2: Transaction Screening - Corporate Client with personEntities only', () => {
