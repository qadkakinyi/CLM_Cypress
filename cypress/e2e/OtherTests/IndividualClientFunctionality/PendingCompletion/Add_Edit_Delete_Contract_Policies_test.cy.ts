/**
 * @testSuite Add, Edit, and Delete Contract Policies
 * @description Creates required Contract Policy configurations in settings, then navigates to a client to add a new Contract Policy.
 * @priority Medium
 * @owner QA Team
 * @tags regression, contract-policy
 */
...
describe.skip('Add Edit and Delete Contract policies', ()=>{
    ...
    /**
     * @setup Create prerequisites for Contract Policies
     * @steps Visit contract setup settings page
     * @steps Add a Contract Policy Category
     * @steps Add a Contract Status
     * @expectedResult Contract Policy Category and Status exist for later test execution
     */
    before(()=>{
    ...
    /**
     * @scenario Add a Contract Policy
     * @steps Go to client list and open the last client in edit mode
     * @steps Navigate to Policies menu
     * @steps Fill in Contract Policy form fields (Policy Number, Particulars, Amounts, Status, Dates, Assigned To, Plan)
     * @expectedResult Contract Policy form is populated and ready to save
     */
